            ...
            <div class="body">
                <form id="sign_up" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="mobile" minlength="6" placeholder="Mobile number" required>
                        </div>
                    </div>
                     <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="pin" minlength="6" placeholder="Pin Code" required>
                        </div>
                    </div>
