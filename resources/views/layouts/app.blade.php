...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{ URL::asset('storage/upload/'.$image) }}" width="48" height="48" alt="User" />
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ url('/pages/examples/sign-in')}}">Sign In</a>
                            </li>
                            <li>
                                <a href="{{ url('/pages/examples/sign-up')}}">Sign Up</a>
                            </li>
                            <li>
                                <a href="{{ url('/pages/examples/forgot-password')}}">Forgot Password</a>
                            </li>
                            <li>
                                <a href="{{ url('/pages/examples/blank')}}">Blank Page</a>
                            </li>
                            <li>
                                <a href="{{ url('/pages/examples/404')}}">404 - Not Found</a>
                            </li>
                            <li>
                                <a href="{{ url('/pages/examples/500')}}">500 - Server Error</a>
                            </li>
                        </ul>
                    </li>
                    <li>
